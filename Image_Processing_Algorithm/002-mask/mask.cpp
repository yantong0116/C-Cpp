...
int main() {
	Mat original = imread("dice.jpg", IMREAD_GRAYSCALE);
	Mat mask = imread("dice.jpg", IMREAD_GRAYSCALE);
	Mat result = imread("dice.jpg", IMREAD_GRAYSCALE);
	Mat pattern = imread("pattern.jpg", IMREAD_GRAYSCALE);
